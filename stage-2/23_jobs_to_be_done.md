...
- Feel that Amazon believes the customer’s account of what happened.
- Feel that the company is taking ownership rather than shifting blame.
- Reduce anxiety about money, deadlines, and replacement availability.
- Preserve confidence in Prime or repeat purchasing.

## Social jobs

- Avoid looking unreliable when a purchase is for an event or family need.
- Be able to recommend Amazon without warning others about exceptions.
- Demonstrate that the purchase was handled fairly.
...
## Stage 2 validation questions

- Which status labels do customers misunderstand most?
- Is a single owner more valuable than faster first response?
- Which evidence makes a delivery handoff trustworthy?
- How much refund detail is enough to reduce anxiety?
- When do customers prefer replacement over refund?
