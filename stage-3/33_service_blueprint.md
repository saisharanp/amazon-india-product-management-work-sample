...
|---|---|---|---|---|---|
| Opens affected order | Exception banner with plain-language status | Help entry point and issue classification | Detect exception and select policy | Order, delivery, seller, payment events | Wrong or stale status |
...
| Reports issue | One-tap non-receipt, damage, or delay action | Case created with priority | Route to correct queue | Support CRM, order ID, delivery ID | Case not routed |
| Reviews options | Delivery recovery, replacement, or refund choices | Eligibility explanation | Apply policy and inventory/payment rules | Policy engine, inventory, payments | Incorrect eligibility |
...
| Exception detected | A signal needs investigation | “We’re checking an issue with this delivery.” | View timeline; get update time |
| Recovery available | A policy-backed option is ready | “Choose delivery recovery, replacement, or refund.” | Select option |
...
3. Which cases require a human owner versus automated recovery?
